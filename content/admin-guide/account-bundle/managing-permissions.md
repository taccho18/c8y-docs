...
> **Important:** On creating a new user, make sure that the global roles you assign to the user cover all permissions relevant for this particular user. If, for example, a user only has the role "Cockpit User" (see below), the user will only be able to access the Cockpit application and nothing more.  


The following pre-configured roles are initially provided.
...
<td align="left">This role has a special status. It is assigned to the first user created in a tenant as initial administrator. All permissions are enabled.</td>
</tr>
<tr><td align="left">CEP Manager</td>
<td align="left">Has full access to all deployed CEP modules and smart rules.</td>
</tr>
<tr>
<td align="left">Cockpit User</td>
<td align="left">Can access the Cockpit application. This does not include the access to any device data. If needed, you should add a role providing access to devices.</td>
</tr>
<tr>
<td align="left">Devicemanagement User</td>
<td align="left">Can access the Device Management application. The user will be able to use the simulator and to run bulk operations. This does not include the access to any device data. If needed, you should add a role providing access to devices.</td>
</tr>
<tr>
<td align="left">devices</td>
<td align="left">This role has a special status. It is the typical permission setup for devices. After registration, a device automatically has this role. Edit this role if your devices require less or more permissions, or assign other roles to your devices.</td>
</tr>
<tr>
...
<td align="left">Can access and edit the full user hierarchy.</td>
</tr>
<tr>
...
<td align="left">Can manage tenant-wide configurations, such as own applications, data retention, tenant options and tenant statistics.</td>
</tr>
</tbody>
</table>
