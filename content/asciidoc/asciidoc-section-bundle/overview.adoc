---
title: Asciidoc file with content
weight: 10
layout: bundle
---
...
.Tiger in a box
image::content/asciidoc/asciidoc-section-bundle/tiger.png[]


include::content/asciidoc/asciidoc-section-bundle/include.asciidoc.txt[]
